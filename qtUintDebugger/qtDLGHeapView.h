...
public:
	...
	* @param flags A value of the Qt::WindowFlags enum which defines how the Dialog is shown
	* @param processID The process id from which the heap will be shown
	*
	* @return no
	*/
	qtDLGHeapView(QWidget *parent = 0, Qt::WindowFlags flags = {}, int processID = 0);
	/**
...
private:
	void SetTablePlaceholder(QTableWidget *table, const QString &message);
	void LoadHeapBlocks(quint64 processID, quint64 heapID);
