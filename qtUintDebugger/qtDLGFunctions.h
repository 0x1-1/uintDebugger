...
public:
	...
	* @return no
	*/
	qtDLGFunctions(qint32 processID, QWidget *parent = 0, Qt::WindowFlags flags = {});
	/**
	* @brief Responsible for initializing and showing the GUI of the function view widget
	* @param processID The process id of which the functions will be shown
	...
	* @return no
	*/
	qtDLGFunctions(qint32 processID, QString modulePath, QWidget *parent = 0, Qt::WindowFlags flags = {});
	/**
