...
qtDLGPEBView::qtDLGPEBView(HANDLE hProc, QWidget *parent, Qt::WindowFlags flags)
	: QWidget(parent, flags)
{
	...
	connect(new QShortcut(Qt::Key_Escape,this),&QShortcut::activated,this,&qtDLGPEBView::close);
...
void qtDLGPEBView::ShowPEBForProcess(HANDLE hProc)
{
	...
	{
		QMessageBox::critical(this,"uintDebugger","NtQueryInformationProcess failed!",QMessageBox::Ok,QMessageBox::Ok);
	...
	{
		QMessageBox::critical(this,"uintDebugger","Read from process memory to get PEB failed!",QMessageBox::Ok,QMessageBox::Ok);
