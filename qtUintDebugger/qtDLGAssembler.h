...
public:
	...
	* @return no
	*/
	qtDLGAssembler(QWidget *parent, Qt::WindowFlags flags, HANDLE processHandle, quint64 instructionOffset, QString currentInstruction, clsDisassembler *pCurrentDisassembler, bool is64Bit);
