 ...
 */
#ifndef QTDLGUINTDEBUGGER_H
#define QTDLGUINTDEBUGGER_H
...
#include "ui_qtDLGUintDebugger.h"
...
class qtDLGUintDebugger : public QMainWindow, public Ui_qtDLGUintDebuggerClass
{
	Q_OBJECT

public:
	static qtDLGUintDebugger* GetInstance();
	...
	qtDLGUintDebugger(QWidget *parent = 0, Qt::WindowFlags flags = {});
	~qtDLGUintDebugger();
...
private slots:
	...
	void action_FileRestartAsAdmin();
...
private:
	...
	static qtDLGUintDebugger *qtDLGMyWindow;
