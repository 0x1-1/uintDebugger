...
qtDLGRegEdit::qtDLGRegEdit(QWidget *parent, Qt::WindowFlags flags,LPVOID pProcessContext,bool is64Bit)
...
void qtDLGRegEdit::OnSaveAndExit()
{
	...
	MessageBoxW(NULL,L"Registers got saved!",L"uintDebugger",MB_OK);
	close();
}