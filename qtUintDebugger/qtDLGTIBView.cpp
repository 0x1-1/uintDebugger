...
qtDLGTIBView::qtDLGTIBView(HANDLE processHandle, HANDLE threadHandle, QWidget *parent, Qt::WindowFlags flags)
...
void qtDLGTIBView::ShowTIBForThread(HANDLE processHandle, HANDLE threadHandle)
{
	...
	{
		QMessageBox::critical(this,"uintDebugger","Read from process memory to get TEB failed!",QMessageBox::Ok,QMessageBox::Ok);
