...
clsAppSettings::clsAppSettings()
	: QObject()
{
	userSettings = new QSettings(QSettings::NativeFormat, QSettings::UserScope, "uintDebugger", "uintDebugger");
...
void clsAppSettings::SaveWindowState(QMainWindow* window)
{
	...
	userSettings->setValue("mainWindowStateVersion", kWindowStateVersion);
	userSettings->sync();
...
bool clsAppSettings::RestoreWindowState(QMainWindow* window)
{
	...
	userSettings->sync();
	if(userSettings->value("mainWindowStateVersion").toInt() == kWindowStateVersion)
	{
...
void clsAppSettings::ResetWindowState()
{
	userSettings->remove("mainWindowGeometry");
	userSettings->remove("mainWindowState");
	userSettings->remove("mainWindowStateVersion");
}
